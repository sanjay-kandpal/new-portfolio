...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am a passionate FullStack Engineer who bridges the gap between front-back
         .{" "}
      </span>
      <span
      ...
      >
        I take responsibility to work frontend-backend to work like a charm using modern
        architecture.
      </span>
    </h1>
  );
